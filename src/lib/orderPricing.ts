...
async function assertSmmServiceAvailable(
  ...
  // Live Rixey catalog commonly takes 8–12s on cold serverless; keep soft
  // checks short so mapped DB services aren't blocked.
  const timeoutMs = required ? 16000 : 1500;
  try {
