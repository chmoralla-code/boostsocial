...
import { Mail, Lock, Megaphone, X, UserPlus, Check, Loader2, Eye, EyeOff } from "lucide-react";
...
export default function QuickStartPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password !== confirmPassword) {
      setFormMessage({
        type: "error",
        text: "Passwords do not match. Please verify your passwords.",
      });
      return;
    }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-[#0a0a0a] border border-slate-800 focus:outline-none focus:border-[#1DB954] focus:ring-1 focus:ring-[#1DB954]/20 text-xs font-semibold text-white placeholder-slate-500 transition-all"
