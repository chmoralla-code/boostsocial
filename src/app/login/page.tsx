          ...
          {mode === "signin" && (
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-[#181818] px-4 text-slate-500 font-semibold uppercase tracking-wider">or continue with</span>
              </div>
            </div>
          )}
          {mode === "signin" && (
            <button
              ...
              disabled={loading}
              className="w-full bg-white hover:bg-gray-100 text-gray-800 font-bold py-3 rounded-full transition-all duration-300 flex justify-center items-center gap-3 text-sm shadow-md hover:shadow-lg cursor-pointer disabled:opacity-50"
            >
        ...
        {mode === "signin" && (
          <>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white hover:bg-gray-100 text-gray-800 font-bold py-3 rounded-full transition-all duration-300 transform hover:scale-[1.02] flex justify-center items-center gap-2.5 uppercase tracking-wider text-xs shadow-md border border-slate-200 cursor-pointer"
            >
