...
const FAQS: FaqItem[] = [
  ...
  {
    question: "Why is PinoyBoosting safer and better than direct automated SMM panels like RixeySMM?",
    answer: "Wholesale automated panels like RixeySMM are built for raw bot-makers; they require complex payment methods (like crypto), offer zero actual customer service, and deliver unfiltered foreign spam accounts that drop rapidly and risk triggering immediate page monetization flags or bans. PinoyBoosting acts as your premium local safety filter: we curate high-retention organic-profile pools, support fast local GCash top-ups, and offer direct 24-hour Taglish support from Cyrhiel Moralla to keep your campaigns 100% compliant and secure."
  }
];
