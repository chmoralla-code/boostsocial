      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="bg-[#181818]/40 border border-slate-800/80 rounded-2xl p-6 text-center hover:bg-[#222]/30 transition-all duration-300 group flex items-center gap-5 sm:flex-col sm:justify-center">
          ...
          <div className="text-left sm:text-center space-y-1">
            ...
            <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Orders Completed</p>
          </div>
        </div>
        ...
        <div className="bg-[#181818]/40 border border-slate-800/80 rounded-2xl p-6 text-center hover:bg-[#222]/30 transition-all duration-300 group flex items-center gap-5 sm:flex-col sm:justify-center">
          ...
          <div className="text-left sm:text-center space-y-1">
            ...
            <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Boosts Delivered</p>
          </div>
        </div>
        ...
        <div className="bg-[#181818]/40 border border-slate-800/80 rounded-2xl p-6 text-center hover:bg-[#222]/30 transition-all duration-300 group flex items-center gap-5 sm:flex-col sm:justify-center">
          ...
          <div className="text-left sm:text-center space-y-1">
            ...
            <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Satisfaction Rate</p>
          </div>
        </div>
      </div>
    </section>
