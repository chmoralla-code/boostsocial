      ...
      <div className="bg-[#181818] border border-slate-800/80 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden relative transform transition-all animate-in zoom-in-95 duration-200 flex flex-col max-h-[85vh]">
        ...
        <div className="p-6 border-b border-slate-800/60 bg-[#1c1c1c]/50">
          <h2 className="text-xl font-black text-white tracking-tight flex items-center gap-2">
            <Gift className="text-[#1DB954]" size={22} /> BoostSocial <span className="text-[#1DB954]">Invite & Earn</span>
          </h2>
        ...
        <div className="p-6 overflow-y-auto flex-grow space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#121212] border border-slate-850 p-4 rounded-xl text-center space-y-1 relative group">
              <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-[#1DB954]/10 text-[#1DB954] border border-[#1DB954]/25 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest">Referee Gets</span>
            ...
            <div className="bg-[#121212] border border-slate-850 p-4 rounded-xl text-center space-y-1 relative group">
              ...
              <h3 className="text-xl font-black text-[#1DB954] pt-1">10%</h3>
          ...
          <div className="bg-[#121212] p-5 rounded-xl border border-slate-800/60 text-center space-y-3.5">
            ...
            <div className="flex flex-col sm:flex-row gap-2 items-stretch justify-center">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-xl font-extrabold text-xs uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-1.5 cursor-pointer shadow-sm ${
                  copied 
                    ? "bg-[#1DB954] text-black shadow-green-500/10" 
            ...
            <div className="inline-flex items-center gap-1 text-[10px] text-[#1DB954] font-bold bg-[#1DB954]/5 border border-[#1DB954]/10 px-2.5 py-1 rounded-full uppercase tracking-wider">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#121212] border border-slate-850 p-4 rounded-xl flex items-center gap-3">
              <div className="p-2.5 bg-[#1DB954]/10 text-[#1DB954] border border-[#1DB954]/25 rounded-xl">
                <Users size={16} />
              </div>
              <div>
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Friends Invited</span>
            ...
            <div className="bg-[#121212] border border-slate-850 p-4 rounded-xl flex items-center gap-3">
              ...
              <div>
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Total Earned</span>
                    ...
                    <div className="space-y-0.5">
                      <div className="font-bold text-white flex items-center gap-1.5">
                        ...
                        {tx.referee_profile?.email ? (
                          ...
                          <span className="text-[9px] bg-[#1DB954]/10 text-[#1DB954] border border-[#1DB954]/20 px-1.5 py-0.2 rounded font-mono">Bonus</span>
                        )}
                      </div>
                      <p className="text-[10px] text-slate-500 tracking-tight leading-tight">{tx.description}</p>
                    </div>
                    <div className="text-right space-y-0.5 pl-3 flex-shrink-0">
                      <span className="font-extrabold text-[#1DB954]">+₱{Number(tx.amount).toFixed(2)}</span>
